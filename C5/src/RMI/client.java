...
public class client {
    public static void main(String[] args) {
        try {
            ...
            function rmi = (function) registry.lookup("function");
            int n;
            while(true) {
                n = message();
                if (n == 6) break;
    ...
    public static int message() {
        ...
        System.out.println("4 : Tính chu vi");
        System.out.println("5 : Tính diện tích");
    ...
    public static void getSwitch(int n, function rmi) {
        ...
        switch(n) {
            ...
            case 3:{
                try {
                    System.out.println("Hiệu là : " + rmi.minus(a, b));
                    break;
                } catch (RemoteException ex) {
                    Logger.getLogger(client.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            case 5:{
                try {
                    System.out.println("Diện tích : " + rmi.acreage(a, b));
                    break;
                } catch (RemoteException ex) {
                    Logger.getLogger(client.class.getName()).log(Level.SEVERE, null, ex);
                }
