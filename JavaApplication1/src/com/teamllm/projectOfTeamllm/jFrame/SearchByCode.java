...
public class SearchByCode extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Search Student By Code");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ((jTextField1.getText().trim().equals(""))) {
            JOptionPane.showMessageDialog(SearchByCode.this, "Vui lòng nhập đầy đủ thông tin", "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
        ...
        //List<Account> stringList1 = center.timkiemID(jTextField1.getText().trim());
        List<Account> stringList1 = center.timKiemCode(Integer.parseInt(jTextField1.getText().trim()));
...
//            java.util.logging.Logger.getLogger(SearchByEmail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new SearchByEmail().setVisible(true);
//            }
//        });
//    }
