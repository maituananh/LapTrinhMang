...
import com.teamllm.projectOfTeamllm.client.ClientLogin;
...
public class SigninUsers extends javax.swing.JFrame {
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if ((jTextField1.getText().trim().equals("")) || (jPasswordField1.getText().trim().equals(""))) {
            ...
            try {
                int res = ClientLogin.client_Login(Integer.parseInt(jTextField1.getText()), jPasswordField1.getText());
                if (res != 0) {
                    AccStatic.setIdStudent(res);
                    AccStatic.setPass(jPasswordField1.getText());
                    boolean b = center.authorization(res);
                    AccStatic.setRole(b);
                    if (b) {
